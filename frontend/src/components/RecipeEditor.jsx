...
export default function RecipeEditor({value, onChange}) {
 ...
 <PreparationTasks value={value} onChange={onChange}/><label>Food video or social post link (TikTok, Instagram, YouTube)<input type="url" value={value.social_url || ''} onChange={e=>onChange({...value,social_url:e.target.value})}/></label>
 </fieldset>;
}
